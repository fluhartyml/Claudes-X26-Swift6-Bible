...
struct Book04_GesturesAndInput: View {
    var body: some View {
        BookPlaceholderView(
            title: "Book 04: Gestures & Input",
            vaultRelativePath: "Part-III-The-User-Interface/Book-04-Gestures-And-Input/Book-04-Gestures-And-Input.html",
