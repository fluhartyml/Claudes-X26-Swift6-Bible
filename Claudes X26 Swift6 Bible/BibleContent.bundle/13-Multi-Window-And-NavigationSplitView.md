...
>
> Browse Inkwell's `ContentView.swift` via its Under the Hood tab, or clone Claudes LockBox at [github.com/fluhartyml/Claudes-LockBox](https://github.com/fluhartyml/Claudes-X26-Swift6-Bible/tree/main/Claudes%20LockBox) and read `ContentView.swift`, `SidebarView.swift`, `ItemListView.swift`, `ItemDetailView.swift`. Both apps put the same chapter into production form. See Build-Along 00 (Inkwell — the meta chapter) and Build-Along 03 (LockBox) for the full walkthroughs.
